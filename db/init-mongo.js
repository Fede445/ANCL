    ...
    [
        {
            ...
            welfare: {
                previdenza: `Contribuzione al fondo Fon.Te. (previdenza complementare per i lavoratori del settore): - a carico azienda, 1,55% della retribuzione utile per il calcolo del tfr; - a carico lavoratore, 0,55% della stessa base di computo, oltre al versamento dell’intero tfr maturato annualmente per coloro che hanno iniziato l’attività lavorativa dopo il 28.4.1993 (50% del tfr maturato se l’attività è iniziata in precedenza).
                ...
                assistenza: `Contribuzione al fondo Est di assistenza sanitaria: - a carico azienda: 10 euro/mese per ciascun lavoratore, sia a tempo pieno che a tempo parziale (dal 1° gennaio 2014); - a carico lavoratore: 2 euro/mese (dal 1° gennaio 2012).
                ...
                - a carico azienda: 50 euro/anno - a carico lavoratore: 25 euro/anno.`,
                ...
                Operatori di vendita. A seguito di infortunio sul lavoro le aziende devono garantire la corresponsione, aggiuntiva al trattamento Inail, dei seguenti importi: - euro 27.500 in caso di morte; - euro 37.500 in caso di invalidità permanente totale.`
            }
        }
    ]
)
